<h2><a href="https://leetcode.com/problems/closest-dessert-cost/?envType=problem-list-v2&envId=backtracking">1900. Closest Dessert Cost</a></h2><h3>Medium</h3><hr><p>You would like to make dessert and are preparing to buy the ingredients. You have <code>n</code> ice cream base flavors and <code>m</code> types of toppings to choose from. You must follow these rules when making your dessert:</p>
